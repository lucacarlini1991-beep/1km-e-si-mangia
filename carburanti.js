...
const fuelNavStyle=document.createElement('style');fuelNavStyle.textContent='.fuel-nav-backdrop{position:fixed;inset:0;background:rgba(0,0,0,.45);z-index:99999;display:flex;align-items:center;justify-content:center;padding:20px}.fuel-nav-box{width:min(360px,100%);background:#fff;border-radius:22px;padding:22px;box-shadow:0 15px 45px rgba(0,0,0,.28);position:relative;text-align:center}.fuel-nav-close{position:absolute;right:12px;top:8px;border:0;background:transparent;font-size:28px;color:#777;cursor:pointer}.fuel-nav-title{font-size:24px;font-weight:900;color:#075c3b}.fuel-nav-subtitle{margin:5px 0 18px;color:#667}.fuel-nav-options{display:grid;gap:10px}.fuel-nav-options a{display:block;text-decoration:none;color:#fff;padding:13px;border-radius:11px;font-weight:900;font-size:16px}.fuel-nav-options a:nth-child(1){background:#075c3b}.fuel-nav-options a:nth-child(2){background:#33b5e5}.fuel-nav-options a:nth-child(3){background:#222}';document.head.appendChild(fuelNavStyle);
function ensureNavModal(){
  if(document.getElementById('fuelNavModal'))return;
  const d=document.createElement('div');
  d.id='fuelNavModal';
  d.innerHTML='<div class="fuel-nav-backdrop"><div class="fuel-nav-box"><button class="fuel-nav-close" aria-label="Chiudi">×</button><div class="fuel-nav-title">NAVIGA</div><div class="fuel-nav-subtitle">Scegli dove aprire il percorso</div><div class="fuel-nav-options"><a id="fuelNavGoogle" target="_blank" rel="noopener">Google Maps</a><a id="fuelNavWaze" target="_blank" rel="noopener">Waze</a><a id="fuelNavApple" target="_blank" rel="noopener">Mappe</a></div></div></div>';

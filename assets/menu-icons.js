(function(){
  const icons={
    ...
    help:'<svg viewBox="0 0 24 24" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="9"/><path d="M9.5 9a2.7 2.7 0 1 1 4.4 2.1c-1.2.9-1.9 1.5-1.9 3"/><path d="M12 17h.01"/></svg>',
  ...
  const byPath={
    'uscite.html':'food',
    'uscita2.html':'map',
    'parcheggi.html':'truck',
    'come-funziona.html':'help',
    'contatti.html':'mail',
    'coming-soon.html':'soon',
    'fonti-licenze.html':'info'
  };

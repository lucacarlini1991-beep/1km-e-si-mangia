...
const tabs={parking:{icon:'🅿️',title:'Parcheggi'},camper:{icon:'🚐',title:'Camper'},places:{icon:'👀',title:'Cosa vedere'}};
...
function openExit(id){
  ...
  exitDescription.textContent='Parcheggi, camper e luoghi nei dintorni.';

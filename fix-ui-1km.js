...
(function () {
  ...
  function bloccaScroll(classe) {
    document.documentElement.classList.add(classe);
    document.body?.classList.add(classe);
  }

  function sbloccaScroll(classe) {
  ...
  function sistemaMenu() {
    ...
    function apri() {
      ...
      panel.style.width = "min(96vw, 900px)";
  ...
  function sistemaSchedaRistoranti() {
    ...
    if (!pannello) {
      sbloccaScroll("restaurant-modal-open");
      return;
    }

    bloccaScroll("restaurant-modal-open");

    if (pannello.dataset.schedaRistorantiFix !== "1") {
      ...
      pannello.style.overscrollBehavior = "contain";
